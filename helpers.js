...
exports.kodiPlayEpisodeHandler = (request, response) => { // eslint-disable-line no-unused-vars
    tryActivateTv(request, response);
    let splitter = request.query.splitter || 'stagione';
    let fullQuery = request.query.q.toLowerCase();
...
exports.kodiExecuteAddonUpdateEpi = (request) => {
    let kodi = request.kodi;
    return kodiOpenVideoWindow( `plugin://plugin.video.SODbyHDs/?%3d`, kodi);
};
...
exports.kodiExecuteAddonSpotyAl = (request) => {
    let kodi = request.kodi;
    let requestedExtra = request.query.q;
    let params = { // eslint-disable-line new-cap
...
exports.kodiExecuteAddonSpotyTr = (request) => {
    let kodi = request.kodi;
    let params = { // eslint-disable-line new-cap
        addonid: 'plugin.audio.spotify' ,params:{action:'browse_savedtracks'
        ,vpq:'vai'}
    };
    return kodi.Addons.ExecuteAddon(params);
};
